...
// flutrust exclusive start
// flytrust stert 
Route::get('/', 'FrontendCOntroller@index');
Route::get('/flight',[WebsiteHomeController::class, 'flight'])->name('flight');


Route::get('/tour',[WebsiteHomeController::class, 'tour'])->name('tour');
Route::get('/hotel',[WebsiteHomeController::class, 'hotel'])->name('hotel');
...
Route::get('/get-unions/{upazila_id}', [MosqueController::class, 'getUnions']);
Route::get('/get-villages/{union_id}', [MosqueController::class, 'getVillages']);
