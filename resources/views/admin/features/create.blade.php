...
@section('title',"Admin Dashboard | Create Feature")
@section('body')
    <section class="pt-5">
            ...
            <form action="{{route('features.store')}}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="feature" id="feature" class="form-control @error('feature') is-invalid @enderror" value="{{old('feature')}}" placeholder="Enter feature" required>
                        @error('feature')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
