            ...
            <form action="{{route('features.update', $data->id)}}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="side_note" id="side_note" class="form-control @error('side_note') is-invalid @enderror" placeholder="Enter side note (plain text only)">{{old('side_note', $data->side_note)}}</textarea>
