            ...
            <form action="{{route('contents.update', $data->id)}}" method="POST">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <textarea name="content" id="content" class="form-control @error('content') is-invalid @enderror" placeholder="Enter content" rows="5" required>{{old('content', $data->content)}}</textarea>
                        @error('content')
