                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="template" id="template" class="form-control @error('template') is-invalid @enderror">
                            ...
                            <option value="call_center" {{ old('template', $data->template) == 'call_center' ? 'selected' : '' }}>Call Center & Cloud PBX</option>
                            <option value="internet_packages" {{ old('template', $data->template) == 'internet_packages' ? 'selected' : '' }}>Internet Packages</option>
                            <option value="business_internet" {{ old('template', $data->template) == 'business_internet' ? 'selected' : '' }}>Business Internet</option>
                            <option value="internet_hero" {{ old('template', $data->template) == 'internet_hero' ? 'selected' : '' }}>Internet Packages Hero</option>
