                            ...
                            <div class="card-body">
                                            ...
                                            <select name="union_id" id="union_id" class="form-control @error('union_id') is-invalid @enderror">
                                                @foreach ($unions as $union)
                                                    <option value="{{ $union->id }}"
                                                        {{ $mosque->union_id == $union->id ? 'selected' : '' }}>
                                                        {{ $union->name }}</option>
                                                @endforeach
                                            </select>
                                            ...
                                            <select name="village_id" id="village_id" class="form-control @error('village_id') is-invalid @enderror">
                                                @foreach ($villages as $village)
                                                    <option value="{{ $village->id }}"
                                                        {{ $mosque->village_id == $village->id ? 'selected' : '' }}>
                                                        {{ $village->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="foundation_year" id="foundation_year" class="form-control @error('foundation_year') is-invalid @enderror"
                                                placeholder="Enter Foundation Year" value="{{ $mosque->foundation_year }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="reg_number" id="reg_number" class="form-control @error('reg_number') is-invalid @enderror"
                                                placeholder="Enter Registration Number" value="{{ $mosque->reg_number }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="secretary_name" id="secretary_name" class="form-control @error('secretary_name') is-invalid @enderror"
                                                placeholder="Enter Secretary Name" value="{{ $mosque->secretary_name }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror"
                                                placeholder="Enter Phone Number" value="{{ $mosque->phone }}" >
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" rows="5"
                                        placeholder="Enter Description">{{ $mosque->description }}</textarea>
...
@push('js')
    <script>
        $(document).ready(function() {
            ...
            var districtId = '{{ $mosque->district_id }}';
            var upazilaId = '{{ $mosque->upazila_id }}';
            var unionId = '{{ $mosque->union_id }}';
            var villageId = '{{ $mosque->village_id }}';
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(key, value) {
                            var selected = districtId == value.id ? 'selected' : '';
                            $('#district_id').append('<option value="' + value.id + '" ' + selected + '>' + value.bn_name + '</option>');
                        });
                        if (districtId) {
                ...
                if (districtId) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(key, value) {
                                var selected = upazilaId == value.id ? 'selected' : '';
                                $('#upazila_id').append('<option value="' + value.id + '" ' + selected + '>' + value.bn_name + '</option>');
                            });
                            if (upazilaId) {
                ...
                if (upazilaId) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(key, value) {
                                var selected = unionId == value.id ? 'selected' : '';
                                $('#union_id').append('<option value="' + value.id + '" ' + selected + '>' + value.bn_name + '</option>');
                            });
                            if (unionId) {
                ...
                if (unionId) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(key, value) {
                                var selected = villageId == value.id ? 'selected' : '';
                                $('#village_id').append('<option value="' + value.id + '" ' + selected + '>' + value.bn_name + '</option>');
                            });
                        }
                    });
                } else {
