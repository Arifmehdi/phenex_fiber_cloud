...
<div class="card-body">
    <div class="form-group">
        <label for="title">Price Title</label>
    ...
    <div class="form-group">
        ...
        <input type="number" name="duration" id="duration" class="form-control @error('duration') is-invalid @enderror" value="{{ old('duration', $cause->duration ?? 0) }}" min="0">
        @error('duration')
            <span class="invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
...
<div class="form-group">
    ...
    <input 
        ...
        value="{{ old('amount', $cause->amount ?? 0) }}"
        min="0"
        step="any">
...
<div class="form-group">
    <label for="raised_amount">Discount Price</label>
    <input 
        type="number"
        name="raised_amount"
        id="raised_amount"
        class="form-control @error('raised_amount') is-invalid @enderror"
        value="{{ old('raised_amount', $cause->raised_amount ?? 0) }}"
        min="0"
        step="any">
...
<div class="form-group">
    <label for="goal_amount">Yearly Price</label>
    <input 
        type="number"
        name="goal_amount"
        id="goal_amount"
        class="form-control @error('goal_amount') is-invalid @enderror"
        value="{{ old('goal_amount', $cause->goal_amount ?? 0) }}"
        min="0"
        step="any"
        required>
