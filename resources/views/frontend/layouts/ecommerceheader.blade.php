        ...
        <div class="header-column">
          <div class="header-row">
              <div class="header-logo">
                  <a href="{{ url('/')}}">
                      <img alt="{{ $ws->website_title ?? '' }}" width="70" height="79"
                          src="{{ (request()->is('product-categories') || request()->is('product-category/*') || request()->is('checkout') || request()->is('product/details/*') || request()->is('shasthoseba')|| request()->is('/')) 
                              ? route('imagecache', [ 'template'=>'original','filename' => $ws->logo() ]) 
                              : route('imagecache', [ 'template'=>'original','filename' => $ws->logo_alt() ]) }}">
                  </a>
              </div>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-submenu">
                                    ...
                                    @elseif ($user && $user->idcard)
                                        ...
                                        <li><a class="dropdown-item" href="{{ route('health.registration') }}">Health Card Registration</a></li>
                                        {{--<li>
