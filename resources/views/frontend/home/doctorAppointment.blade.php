            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-lg border-0 rounded">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('spBook') }}" method="POST">
                            @csrf
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="chamber_select" name="chambar_location" class="form-select" required style="font-size: 13px">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="schedule_select" name="chamber_schedule" class="form-select" required style="font-size: 13px">
                               ...
                               <!-- Appointment Date -->
                                ...
                                <!-- WhatsApp Number -->
                                <div class="col-12">
                                    <label class="form-label">WhatsApp Number (Incase of Video Consultation)</label>
                                    <input type="number" name="whatsapp_number" class="form-control" placeholder="WhatsApp Mobile" >
                                </div>
                            ...
                            <div class="text-center mt-4">
                                <button type="submit" class="btn px-5 py-2 text-white" style="background : #2D529F">Make Appointment</button>
                            </div>
                        </form>
...
<script>
    ...
    // Set min attribute so past dates are disabled
